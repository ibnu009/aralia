...
import {REST_URL, HEADERS_CONFIG, getIndoFormatDate} from 'aralia/AppConfig';
            ...
            <List>
              <ListItem>
                ...
                <DatePicker
                  ...
                  format="DD/MM/YYYY"
                  minDate={`${new Date().getDate()}/${new Date().getMonth() +
                    1}/${new Date().getFullYear()}`}
                  confirmBtnText="Ok"
                  cancelBtnText="Batal"
                  customStyles={{datePicker: {backgroundColor: '#fff'},placeholderText: { color: '#000' }}}
