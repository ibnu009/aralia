        ...
        <Content>
          <Form >
            ...
            <View style={{ flexDirection:'row' , alignItems:'center', paddingRight: 10}}>
              <Input secureTextEntry={this.state.password_state_old} onChangeText={(e) => this.setState({ pass_old : e })} />
              <Icon name={this.state.icon_old} onPress={() => this._changeIconOld()} />
              </View>
            </Item>
            <Item stackedLabel>
              <Label>Password Baru</Label>
              <View style={{ flexDirection:'row' , alignItems:'center', paddingRight: 10}}>
              <Input secureTextEntry={this.state.password_state_new} onChangeText={(e) => this.setState({ pass_new : e })} />
              <Icon name={this.state.icon_new} onPress={() => this._changeIconNew()} />
              </View>
            </Item>
            <Item stackedLabel last>
              <Label>Verifikasi Password</Label>
              <View style={{ flexDirection:'row' , alignItems:'center', paddingRight: 10}}>
              <Input secureTextEntry={this.state.password_state_ver} onChangeText={(e) => this.setState({ verify : e })} />
              <Icon name={this.state.icon_ver} onPress={() => this._changeIconVer()} />
              </View>
            </Item>
          </Form>
          <Card>
