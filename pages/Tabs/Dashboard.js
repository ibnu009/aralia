...
import { REST_URL } from 'aralia/AppConfig';
...
class TabDashboard extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({ isBanner : (userData["is_banner"] == "1" ? true : false) , nip: userData['employee_id']});
        ...
        <Content
          ...
          <ImageBackground
            ...
            <View style={{
              ...
              <View style={{alignContent: 'center', flexDirection: 'column', height: 50}}>
                <Image
                  source={
                    user.url_foto
                      ? {uri: user.url_foto}
