...
export async function getAbsensiData(nip?: String, year?: String, month?: String) {
  ...
  .then(res => {
    ...
    if(res.status == "success"){
      ...
      Toast.show(`Data absensi belum ada. Silahkan ulangi beberapa saat lagi.`, Toast.SHORT);
    }
  })
  .catch(err => {
    store.setLoading(false);
