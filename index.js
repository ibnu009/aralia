      ...
      <NavigationContainer>
        ...
        <Stack.Navigator
          ...
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="OfficeUpdate"
            component={route.OfficeUpdate}
          />
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="ChangePassword"
            component={route.ChangePassword}
          />
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="ChangeProfile"
          ...
          <Stack.Screen
            ...
            component={route.PreviewAttachment}
          />
          ...
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="SppdRequest"
            component={route.SppdRequest}
          />

          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="SppdRespons"
            component={route.SppdRespons}
          />

          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="SppdResponsDetail"
            component={route.SppdResponsDetail}
          />
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="Sppd"
            component={route.Sppd}
          />
          ...
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="PaySlipView"
            component={route.PayslipView}
          />
          <Stack.Screen
            options={TransitionPresets.SlideFromRightIOS}
            name="PaySlipList"
            component={route.PaySlipList}
          />
